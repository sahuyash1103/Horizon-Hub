    ...
    return (
      <div className="left-container">
       <div className="chat-list">
        ...
        <div className="chat-box">
          <div className="img-box">
            <img className="img-cover" src="https://thumbs.dreamstime.com/b/male-avatar-profile-icon-round-man-face-male-avatar-profile-icon-round-man-face-flat-vector-illustration-102767980.jpg" alt=""/>
          </div>
          <div className="chat-details">
            <div className="text-head">
              <h4>Satyam</h4>
        ...
        <div className="chat-box">
          <div className="img-box">
            <img className="img-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVfVYXuyABJpg2S1xgFB14nO6R2xa85GnIhVrfd_UmHt_EYdXwh0q3iEA-QlGXNzdehhA&usqp=CAU" alt=""/>
          </div>
          <div className="chat-details">
            <div className="text-head">
              <h4>Shifa</h4>
        ...
        <div className="chat-box">
          <div className="img-box">
            <img className="img-cover" src="https://media.licdn.com/dms/image/C4D03AQEPYhOrGAYffQ/profile-displayphoto-shrink_800_800/0/1662200759724?e=2147483647&v=beta&t=yw-PtQnM20byydFw6aC4mdiZ5UsodCtkb5cns759UuU" alt=""/>
          </div>
          <div className="chat-details">
            <div className="text-head">
              <h4>Taliha</h4>
